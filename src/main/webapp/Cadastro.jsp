      ...
      <div class="row" style="">
        <div class="mx-auto col-lg-6 col-10">
          ...
          <form class="text-left">
            ...
            <div class="form-row">
              <div class="form-group col-md-6"> <label for="form19">Senha</label> <input type="password" class="form-control" id="form19" placeholder="••••"> </div>
          ...
          </form><button type="submit" class="btn btn-primary" contenteditable="true">Registrar-se</button>
        </div>
      </div>
    </div>
  </div>
  <div class="p-0 py-3 pr-5" style="" >
    <div class="container">
      <div class="row">
        <div class="col-md-12 text-center d-md-flex align-items-center" style=""> <i class="d-block fa fa-stop-circle fa-2x mr-md-5 text-primary"></i>
